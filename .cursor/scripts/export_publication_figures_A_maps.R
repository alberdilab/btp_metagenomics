...
save_publication_figure(fig_A1, "fig_A1_tasmania_environment_map.pdf", height_mm = 110)
save_publication_figure(fig_A2, "fig_A2_tasmania_devil_density_map.pdf", height_mm = 110)

cat("Exported A1–A2 to figures/\n")
