...
author:
  - Lukas Fix, Antton Alberdi, Raphael Eisenhofer[University of Copenhagen, raphael.eisenhofer@sund.ku.dk]
date: "`r Sys.Date()`"
...
description: |
  Data analysis code for the study of Tasmanian brush-tail possums.
link-citations: yes
...
```{r function_tree_visu, message=FALSE, warning=FALSE, fig.height=6, fig.width=10, fig.fullwidth=TRUE}
