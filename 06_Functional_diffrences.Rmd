...
Between-sample dissimilarity using Hill-based distances (richness, neutral, phylogenetic, functional), PERMANOVA tests for broad environment/sex effects, and NMDS ordinations to visualise separation in community structure.
...
NMDS of β-diversity (richness/neutral/phylogenetic/functional). Points are samples, coloured by broad environment and shaped by sex; segments draw each point to its group centroid.
